...
def show_venue(venue_id):
    ...
    for show in (
        ...
        upcoming_Shows_Nums.add(show.artist_id)
    ...
    for show in (
        ...
        past_Shows_Nums.add(show.artist_id)
    ...
    data = {
        ...
        "upcoming_shows_count": len(upcoming_Shows_Nums),
        "upcoming_shows": upcoming_shows,
        "past_shows_count": len(past_Shows_Nums),
